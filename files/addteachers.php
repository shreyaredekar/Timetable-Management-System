            ...
            <div style="display:none" id="addTeacherForm">
                <form action="addteacherFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="teachercontactnumber" name="TP"
                               placeholder="+91 ..." min="6000000000" max="9999999999" required>
                    </div>

                    <div class="form-group">
                        <label for="teacheremailid">Email-ID</label>
                        <input type="email" class="form-control" id="teacheremailid" name="TE"
