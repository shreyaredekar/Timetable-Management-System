...
function add_subject(period,semester,day) {
...
function remove_subject(period,semester,day) {
    var remove_subject="remove_subject";
    $.ajax({
        url: "facultypage_backend.php",
        type: "POST",
        data: {
...
function add_period(semester,period,day){
    var period1="'"+period+"'";
    var semester1="'"+semester+"'";
    var day1="'"+day+"'";
    var data='<button type="button" class="btn btn-primary" onclick="add_subject('+period1+','+semester1+','+day1+')">Add</button></a>'+
    '&nbsp;<button type="button" class="btn btn-danger" onclick="remove_subject('+period1+','+semester1+','+day1+')">Remove</button>'+
            '&nbsp;<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>';
    document.getElementById("display_button").innerHTML=data;
}
