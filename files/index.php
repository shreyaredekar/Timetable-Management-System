...
if (isset($_GET['generated']) && $_GET['generated'] == "false") {
    ...
    echo '<script>alert("Timetable not generated yet!!");</sc1ript>';
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Timetable Handling</title>
...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">TIMETABLE HANDLING, COMPUTER SCIENCE AND ENGINEERING DEPARTMENT</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
            <img src="assets/img/img4.jpg" alt="Flower">
        </div>
    </div>
</div>
        ...
        <div style="display:none" id="facultyForm">
            <form action="facultyformvalidation.php" method="POST" style="overflow: hidden">
                <div class="form-group" style="padding:10px">
                    ...
                    <input type="text" class="form-control" id="facultyno" name="FN" placeholder="Faculty No. ..."><br>
                    <input type="password" class="form-control m-3" id="facultypassword" name="password" placeholder="Password">
                </div>
                <div align="right">
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/img1.png" class="img-rounded"/>
                    <h3 align="center">Prof. G Patil</h3>
                    <hr/>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/img2.png" class="img-rounded"/>
                    <h3 align="center">PROF. S Chede</h3>
                    <hr/>
                    <h4 align="center">Principal<br/> DYPCET</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/img3.png" class="img-rounded"/>
                    <h3 align="center">PROF. S Patil</h3>
                    <hr/>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4><strong>Email: </strong>dypgroup@gmail.com</h4>
            </div>
